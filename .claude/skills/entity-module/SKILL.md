---
name: entity-module
description: "The canonical NestJS entity module - folder tree, layer boundaries, and the rules for the module, controller, service, repository, entity, interface, DTO, and constants files. Use whenever creating a new entity, adding a file to an existing module, or deciding which layer a piece of server code belongs in."
---
